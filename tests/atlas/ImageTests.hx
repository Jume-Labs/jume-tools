...
class ImageTests extends Test {
  function testEmptyImage() {
    ...
    final image = new Image({ size: { width: imageWidth, height: imageHeight } });
  ...
  function testGetAndSetPixel() {
    ...
    final image = new Image({ size: { width: 32, height: 32 } });
  ...
  function testImageFromBytes() {
    ...
    final image = new Image({ size: { width: width, height: height }, bytes: bytes });
  ...
  function testInsertImage() {
    final image = new Image({ size: { width: 40, height: 40 } });
    ...
    final other = new Image({ size: { width: 20, height: 20 } });
